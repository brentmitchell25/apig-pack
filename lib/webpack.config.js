...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      // {
      //   test: /sigV4Client.js$/,
      //   loader: `imports-loader?document=>new (require("jsdom")).JSDOM().window.document`
      // },
      // {
      //   test: /sigV4Client.js$/,
      //   loader: `imports-loader?parser=>{},parser.href=>require("url").parse(awsSigV4Client.endpoint)`
      // },
      {
        test: /sigV4Client.js$/,
        loader: `imports-loader?url=url`
      },
      {
        test: /apigClient.js$/,
        loader:
